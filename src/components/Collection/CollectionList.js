...
const CollectionList = ({ productList, handleStatusChange, filterBySearch, activeTab, setActiveTab }) => {
	return (
		<div className=''>
			<div className='flex justify-start px-5 py-5 items-end'>
				<h2 className='w-[50%] font-[GilroyBold] text-[25px]'>Collection List</h2>
			...
			<div>
				<TopCollection setActiveTab={setActiveTab} activeTab={activeTab} />
			</div>
			<div className={`bg-gray-300  py-4 px-8 grid  gap-6 grid-flow-row  items-center justify-start grid-cols-2 lg:grid-cols-9  `}>
				...
				<p className='col-span-1 font-[GilroyMedium]' >Product Quantity</p>
